...
![github wiki sidebar generated by github-wiki-sidebar](https://raw.githubusercontent.com/wiki/morris-kelly/github-wiki-sidebar/images/github-wiki-sidebar-generator.png)

See examples of sidebar menu generated by this module at [github-wiki-sidebar's Wiki](https://github.com/adriantanasa/github-wiki-sidebar/wiki) and more in the _Examples_ section (as [AngularJS](https://github.com/angular/angular.js/wiki), [ng-bootstrap](https://github.com/ng-bootstrap/ng-bootstrap/wiki), etc.)
...
```shell
git clone https://github.com/morris-kelly/github-wiki-sidebar.wiki.git
...
Allows the user to change the links to a different format (default is relative). A full URI could be used for ex: `https://github.com/morris-kelly/github-wiki-sidebar/wiki/%s`
...
```
[![npm module\](https://rawgit.com/wiki/morris-kelly/gi
...
Execute the script in init mode and at the _Select the \_Sidebar.md content template: %s_ change the default template with one that will include the logo:
...
Check [Roadmap](https://github.com/morris-kelly/github-wiki-sidebar/wiki/Roadmap) for planned items.
...
[npm-image]: https://img.shields.io/npm/v/@morris-kelly/github-wiki-sidebar.svg
[npm-url]: https://www.npmjs.com/package/@morris-kelly/github-wiki-sidebar
[downloads-image]: https://img.shields.io/npm/dm/@morris-kelly/github-wiki-sidebar.svg
[downloads-url]: https://npmjs.org/package/@morris-kelly/github-wiki-sidebar
